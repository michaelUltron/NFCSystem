        ...
        <main className="flex-1 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <p className="text-3xl font-bold">{totalTaps}</p>
            </div>
                  ...
                  <div key={tap.id} className="border rounded-xl p-4">
                    <div className="flex items-start justify-between gap-4">
                      <div className="space-y-1 text-sm text-gray-700">
                        <p>
                          <strong>Card UID:</strong> {tap.cards?.card_uid || "Unknown"}
                        </p>
                        <p>
                          <strong>Device:</strong> {tap.device || "Unknown"}
                        </p>
                        <p>
                          <strong>Browser:</strong> {tap.browser || "Unknown"}
                        </p>
                        <p>
                          <strong>Referrer:</strong> {tap.referrer || "Direct"}
                        </p>
                      </div>
